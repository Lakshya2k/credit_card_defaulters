    ...
    def get_best_params_for_naive_bayes(self, train_x, train_y):
        ...
        try:
            ...
            self.grid = GridSearchCV(
                estimator=self.gnb, param_grid=self.param_grid, cv=3, verbose=3
            )
    ...
    def get_best_model(self, train_x, train_y, test_x, test_y):
        ...
        try:
            ...
            if (
                ...
                self.logger_object.log(
                    self.file_object, "Accuracy for NB:" + str(self.naive_bayes_score)
                )
            else:
                ...
                self.logger_object.log(
                    self.file_object, "AUC for RF:" + str(self.naive_bayes_score)
                )
